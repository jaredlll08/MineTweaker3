...
craftingTable.addShapeless("nested_conditions", <item:minecraft:dirt>, [<item:minecraft:stone_shovel>.onlyDamaged().onlyIf("enchanted_condition", stack => stack.hasEnchantments)]);
craftingTable.addShapeless("list_conditions", <item:minecraft:dirt>, [(<item:minecraft:stone_axe>.onlyDamaged() | <item:minecraft:golden_axe>).onlyIf("enchanted_condition", stack => stack.hasEnchantments)]);
