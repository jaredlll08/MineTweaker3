...
public class ReplacerGameTests implements CraftTweakerGameTest {
    ...
    public void testReplacer(GameTestHelper helper, ScriptBuilder builder) {
        ...
        Optional<RecipeHolder<?>> recipe = recipeManager.byKey(ResourceLocation.parse("crafttweaker:autogenerated/replacer/minecraft.iron_boots.1"));
    ...
    public void testCustomFilteringRule(GameTestHelper helper, ScriptBuilder builder) {
        ...
        //Test that the recipes were indeed replaced
        Optional<RecipeHolder<?>> recipe = recipeManager.byKey( ResourceLocation.parse("crafttweaker:autogenerated/replacer/minecraft.diamond_block.1"));
        Optional<RecipeHolder<?>> unreplaced = recipeManager.byKey(ResourceLocation.parse("minecraft:diamond_boots"));
